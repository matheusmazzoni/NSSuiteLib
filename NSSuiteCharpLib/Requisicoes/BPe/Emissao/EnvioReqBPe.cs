...
namespace NSSuiteCSharpLib.Requisicoes.BPe
{
    ...
    public class EnvioReqBPe : Emissao, IEnvioReq
    {
        ...
        public string EnviarEmissaoAPI(bool a3)
        {
            if (a3)
            {
                ...
                return EnviarEmissaoComAssinatura(this, Projeto.BPe, versao, cUF, dhEmi, serie, nBP, tpEmis, cBP,
                    cnpjEmitente, Endpoints.BPeEnvio);
            }
            else
                return EnviarEmissao(JsonConvert.SerializeObject(this), Projeto.BPe, Endpoints.BPeEnvio);
        }

        public string EnviarEmissaoSincrona(string tpDown, string caminho, bool exibirNaTela, bool a3)
        {
            string cnpjEmitente = BPe.infBPe.emit.CNPJ;
            string tpAmb = BPe.infBPe.ide.tpAmb;
            return EnviarEmissao(this, Projeto.BPe, cnpjEmitente, tpAmb, tpDown, caminho, exibirNaTela, a3);
        }

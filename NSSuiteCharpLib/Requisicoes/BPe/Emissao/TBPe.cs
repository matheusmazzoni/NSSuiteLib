...
public partial class TBPe : TemplateEnvioReq {
    ...
    public override IDownload GetObjectDownload(ConsStatusProcessamentoResp consultarResp, string tpDown)
    {
        ...
        downloadReq.chBPe = (consultarResp as ConsStatusProcessamentoRespBPe).chBPe;
        return downloadReq;
    }
    ...
    public override string EnviarEmissao(bool a3)
    {
        ...
        if (a3)
        {
            ...
            resposta = EnviarEmissaoDocumento(this, Projeto.BPe, cUF, dhEmi, serie, nBP, tpEmis, cBP,
